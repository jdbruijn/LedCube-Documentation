\hypertarget{_bit_operations_8c}{}\section{source/\+Library\+Files/src/\+Bit\+Operations.c File Reference}
\label{_bit_operations_8c}\index{source/\+Library\+Files/src/\+Bit\+Operations.\+c@{source/\+Library\+Files/src/\+Bit\+Operations.\+c}}
...
\item 
bool \hyperlink{_bit_operations_8c_ab7b317748b9d8e08812603975b2ad3fc}{is\+Positive} (int32\+\_\+t const \+\_\+v)
\begin{DoxyCompactList}\small\item\em Compute the sign of an integer. \end{DoxyCompactList}\item 
bool \hyperlink{_bit_operations_8c_a5a16a55c4150b94d46a15bb4bdb16ab8}{have\+Opposite\+Signs} (int32\+\_\+t const \+\_\+x, int32\+\_\+t const \+\_\+y)
\begin{DoxyCompactList}\small\item\em Detect if two integers have opposite signs. \end{DoxyCompactList}\item 
int32\+\_\+t \hyperlink{_bit_operations_8c_a2a80e0c1b11281eedafad0691563e986}{min} (int32\+\_\+t const \+\_\+x, int32\+\_\+t const \+\_\+y)
\begin{DoxyCompactList}\small\item\em Compute the minimum of two integers without branching. \end{DoxyCompactList}\item 
int32\+\_\+t \hyperlink{_bit_operations_8c_a98b24b67752cb7a65d0bf14efd403a72}{max} (int32\+\_\+t const \+\_\+x, int32\+\_\+t const \+\_\+y)
\begin{DoxyCompactList}\small\item\em Compute the maximum of two integers without branching. \end{DoxyCompactList}\item 
bool \hyperlink{_bit_operations_8c_a26c3096ce57c1349f70a845b55eda1d2}{is\+Power\+Of2} (int32\+\_\+t const \+\_\+v)
\begin{DoxyCompactList}\small\item\em Determining if an integer is a power of two. \end{DoxyCompactList}\item 
void \hyperlink{_bit_operations_8c_a4859424c19f3385795a4d3481153e41e}{modify\+Bits} (uint32\+\_\+t $\ast$\+\_\+v, uint32\+\_\+t const \+\_\+mask, bool const \+\_\+f)
\begin{DoxyCompactList}\small\item\em Conditionally set or clear bits without branching. \end{DoxyCompactList}\item 
uint32\+\_\+t \hyperlink{_bit_operations_8c_ac10caf47473a5d1c6b3cfd6808d61d9e}{merge\+Bits} (uint32\+\_\+t const \+\_\+x, uint32\+\_\+t const \+\_\+y, uint32\+\_\+t const \+\_\+mask)
\begin{DoxyCompactList}\small\item\em Merge bits from two values according to a mask. \end{DoxyCompactList}\item 
uint8\+\_\+t \hyperlink{_bit_operations_8c_a37bec38f51814420e4e81f8aed5f7bac}{n\+Bits\+Set} (int32\+\_\+t const \+\_\+v)
\begin{DoxyCompactList}\small\item\em Counting bits set. \end{DoxyCompactList}\item 
bool \hyperlink{_bit_operations_8c_a52bc2e61d1421227989ecefb66cf51b1}{is\+Even} (uint32\+\_\+t const \+\_\+v)
\begin{DoxyCompactList}\small\item\em Compute parity of word with a multiply. \end{DoxyCompactList}\item 
void \hyperlink{_bit_operations_8c_a0d25828bba771d7dc9a8e4bfd15d77c0}{reverse\+Bit\+Order} (uint32\+\_\+t $\ast$\+\_\+v)
...
uint32\+\_\+t \hyperlink{_bit_operations_8c_afda0074f3c08ef6c9f6c9a481dafd7c6}{round\+Up\+To\+Power\+Of2} (uint32\+\_\+t const \+\_\+v)
...
\hypertarget{_bit_operations_8c_ab7b317748b9d8e08812603975b2ad3fc}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!is\+Positive@{is\+Positive}}
...
)}\label{_bit_operations_8c_ab7b317748b9d8e08812603975b2ad3fc}
...
\hypertarget{_bit_operations_8c_a5a16a55c4150b94d46a15bb4bdb16ab8}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!have\+Opposite\+Signs@{have\+Opposite\+Signs}}
...
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a5a16a55c4150b94d46a15bb4bdb16ab8}
...
\hypertarget{_bit_operations_8c_a2a80e0c1b11281eedafad0691563e986}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!min@{min}}
...
\item[{int32\+\_\+t const}]{\+\_\+y}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a2a80e0c1b11281eedafad0691563e986}
...
\hypertarget{_bit_operations_8c_a98b24b67752cb7a65d0bf14efd403a72}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!max@{max}}
...
\item[{int32\+\_\+t const}]{\+\_\+y}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a98b24b67752cb7a65d0bf14efd403a72}
...
\hypertarget{_bit_operations_8c_a26c3096ce57c1349f70a845b55eda1d2}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!is\+Power\+Of2@{is\+Power\+Of2}}
...
\item[{int32\+\_\+t const}]{\+\_\+v}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a26c3096ce57c1349f70a845b55eda1d2}
...
\hypertarget{_bit_operations_8c_a4859424c19f3385795a4d3481153e41e}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!modify\+Bits@{modify\+Bits}}
...
\item[{bool const}]{\+\_\+f}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a4859424c19f3385795a4d3481153e41e}
...
\hypertarget{_bit_operations_8c_ac10caf47473a5d1c6b3cfd6808d61d9e}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!merge\+Bits@{merge\+Bits}}
...
\item[{uint32\+\_\+t const}]{\+\_\+mask}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_ac10caf47473a5d1c6b3cfd6808d61d9e}
...
\hypertarget{_bit_operations_8c_a37bec38f51814420e4e81f8aed5f7bac}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!n\+Bits\+Set@{n\+Bits\+Set}}
...
\item[{int32\+\_\+t const}]{\+\_\+v}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a37bec38f51814420e4e81f8aed5f7bac}
...
\hypertarget{_bit_operations_8c_a52bc2e61d1421227989ecefb66cf51b1}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!is\+Even@{is\+Even}}
...
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a52bc2e61d1421227989ecefb66cf51b1}
...
\hypertarget{_bit_operations_8c_a0d25828bba771d7dc9a8e4bfd15d77c0}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!reverse\+Bit\+Order@{reverse\+Bit\+Order}}
...
\item[{uint32\+\_\+t $\ast$}]{\+\_\+v}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_a0d25828bba771d7dc9a8e4bfd15d77c0}
...
\hypertarget{_bit_operations_8c_afda0074f3c08ef6c9f6c9a481dafd7c6}{}\index{Bit\+Operations.\+c@{Bit\+Operations.\+c}!round\+Up\+To\+Power\+Of2@{round\+Up\+To\+Power\+Of2}}
...
\item[{uint32\+\_\+t const}]{\+\_\+v}
\end{DoxyParamCaption}
)}\label{_bit_operations_8c_afda0074f3c08ef6c9f6c9a481dafd7c6}
